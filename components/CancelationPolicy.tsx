...
export default function CancellationPolicy():JSX.Element{
    return(
        <View style={styles.container}>
            ...
            <Text style={{fontSize:17 ,fontWeight:300 , paddingVertical:17}}>Cancel 12 hours in advance to avoid a $8.00 late cancellation fee , A missed reservation will result in a $11.00 fee</Text>
